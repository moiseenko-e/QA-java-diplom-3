...
public class MainPage {
    ...
    @Step("Получить значение атрибута class у родительского элемента {elementName}")
    public String getAttributeValueClassFromParentByElement(String elementName){
        return driver.findElement(By.xpath("//span[contains(text(),'" + elementName + "')]/parent::div"))
                .getAttribute("class");
    }
